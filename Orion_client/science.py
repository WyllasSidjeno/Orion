...
class ArbreScience:
    ...
    sciences: dict = {'science_0': [0, True, 4, "available"], 'science_1': [1, True, 5, "available"], 'science_2':
        [2, False, 8, "unlockable"], 'science_3': [3, False, 9, "unlockable"], 'science_4': [4, False, 10, "blocked"]
        , 'science_5': [5, False, 11, "blocked"], 'science_6': [6, False, 13, "blocked"], 'science_7': [7, False, 15,
                                                                                                        "blocked"]}
...
class Controller:
    ...
    def show_science(self, data):
        ...
        for i, science in enumerate(data.sciences):
            ...
            if self.is_clickable(f"{science}", data):
    ...
    def buy_science(self, event, science, data):
        """Achete la science"""
        data.sciences.get(science)[3] = "available"
